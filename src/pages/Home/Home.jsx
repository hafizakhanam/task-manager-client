    ...
    return (
        <div>
            ...
            <div className="bg-teal-700 min-h-screen items-center justify-center flex flex-col">
                <h1 className="text-4xl lg:text-8xl text-white font-bold mb-12">Manage Your Task</h1>
                <p className="text-white text-2xl mb-12">Empower Your Productivity: Seamlessly Manage Tasks, Achieve Goals.<br/> and Unlock Your Full Potential with Our Task Management App!</p>
